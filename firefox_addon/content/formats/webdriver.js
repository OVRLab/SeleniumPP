 ...
 */
//var EXPORTED_SYMBOLS = ["run", "formatCommand"];
...
var subScriptLoader2 = Components.classes["@mozilla.org/moz/jssubscript-loader;1"].getService(Components.interfaces.mozIJSSubScriptLoader);
subScriptLoader2.loadSubScript('chrome://seleniumideinterface/content/formats/cs-iwd.js', this);
/* @override
...
//    line = formatComment(new Comment(statement(call)));
    line = e;//formatComment(new Comment('ERROR: Caught exception [' + e + ']'));
  }
